...
function setup() {
	...
	stone = new Stone(170,700,20);
	mango1 = new Mango(1000,300,20);
	mango2 = new Mango(1100,250,20);
	mango3 = new Mango(1000,180,20);
	mango4 = new Mango(940,240,20);
	mango5 = new Mango(1100,170,20);
	mango6 = new Mango(1200,300,20);
  mango7 = new Mango(1110,300,20);
  mango8= new Mango(1000,265,20);
  mango9 = new Mango(960,290,20);
